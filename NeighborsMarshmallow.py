...
class KnnRecommender:
    def __init__(self, file):
        ...
        self.insurance_details =     ['General liability', 'Workers conpesation',
    ...
    def _parse_json(self):
        ...
        #preparing the data
        self._prep_data(self.json_dict)
    ...
    def _inference(self, df, df_features, user):
        ...
        self.make_recommendations(df, user, indices)
        ...
        if query:
            ...
            for k, v in risk_profile.items():
                for k1 in v.keys():
                    # z[k1]=v[]
                    policy_price[k1] = {}
                    policy_price[k1]['price'] = v[k1] * self.baseprice[k1]
                    policy_price[k1]['risk'] = v[k1]
            print(policy_price)
    ...
    def _prep_data(self, json):
        ...
        cmp_final = pd.concat([cmp, df_json], axis=0).reset_index()
...
if __name__ == '__main__':
    knn = KnnRecommender("/Users/shravanamee/Desktop/projects/REWRITE/Companies and Insurances.csv")
    knn._parse_json()